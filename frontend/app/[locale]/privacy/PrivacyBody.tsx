      ...
      <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              {t(
                "No password, OAuth token, or Steam session token. Steam sign-in is one-shot OpenID; we never see your credentials.",
              )}
            </li>
            <li>
              {t(
                "No email address (unless you voluntarily provide one as a contact value when submitting feedback).",
              )}
            </li>
            <li>
              {t(
                "No cross-site tracking beyond what's described in the Advertising section. We use Google Analytics and self-hosted Umami for aggregate traffic statistics, and NitroPay for advertising, nothing else, no Meta Pixel, no data brokers.",
              )}
            </li>
            <li>
              {t(
                "No payment information. Donations are handled by Ko-fi on its own site.",
              )}
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              {t(
                "Run data powers leaderboards, community statistics, and shareable run links.",
              )}
            </li>
            <li>
              {t(
                "Steam identifiers tie submitted runs to a profile so you can claim and manage your own history.",
              )}
            </li>
            <li>
              {t(
                "Server logs are used to debug issues, monitor performance, and stop abuse.",
              )}
            </li>
            <li>
              {t(
                "Feedback is forwarded to a private Discord channel and a GitHub issue tracker so we can act on it.",
              )}
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            <strong className="text-[var(--text-primary)]">
              {t("If you are in the EEA, UK, or Switzerland")}
            </strong>
            {t(
          ...
          <p className="mt-2">
            <strong className="text-[var(--text-primary)]">
              {t("If you are a California resident")}
            </strong>
            {t(
        ...
        <section>
          ...
          <p>
            ...
            <a
              href="https://spire-codex.com/api/runs/list"
              className="text-[var(--accent-gold)] hover:underline"
            >
              /api/runs/list
            </a>
        ...
        <section>
          ...
          <p>
            ...
            {t(
              ". Include the SteamID or run hash you’d like removed. We process requests within a reasonable time and confirm by reply.",
            )}
          </p>
        </section>
