...
/**
 * The canonical /archetypes route re-exports this module, so it renders
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    // English page has always advertised the localized variants, so they
    // self-canonicalize per locale rather than folding back to English.
    alternates: {
      canonical: `${SITE_URL}${prefix}/archetypes`,
      languages: buildLanguageAlternates("/archetypes"),
    },
    openGraph: {
      title,
      description,
      url: `${SITE_URL}${prefix}/archetypes`,
      siteName: SITE_NAME,
      type: "website",
